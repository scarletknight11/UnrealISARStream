...
#ifndef HOLOLIGHT_UNREAL_STREAMXR_PLATFORM_DEFINES_H
#define HOLOLIGHT_UNREAL_STREAMXR_PLATFORM_DEFINES_H
...
#endif // HOLOLIGHT_UNREAL_STREAMXR_PLATFORM_DEFINES_H
